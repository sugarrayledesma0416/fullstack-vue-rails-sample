describe QuestionBanks::DropDownBuilder do
  let(:choices) { 2 }
  ...
  let(:row_with_2_choices) do
    ...
    {
      prompt: 'row with 2 choices @@menu@@',
      correct_answer: 'a',
      distractor_1: 'b'
    }
  end
  ...
  let(:row_with_3_choices) do
    # order of keys must match column order of csv file
    {
      prompt: 'row with 3 choices @@menu@@',
      correct_answer: 'a',
      distractor_1: 'b',
      distractor_2: 'c'
    }
  ...
  let(:row_with_4_choices) do
    # order of keys must match column order of csv file
    {
      prompt: 'row with 4 choices @@menu@@',
      correct_answer: 'a',
      distractor_1: 'b',
      distractor_2: 'c',
      distractor_3: 'd'
  ...
  describe '#content_object' do
    ...
    it 'calls .from_csv_hash on the DropDownContent class, passing in ' \
          ...
          item_data: [
            {
              ...
              number: 1,
              prompt: 'row with 2 choices <wol ref="1" />'
            }
          ]
        )
      )
    ...
    it 'handles markdown for bold and italics in the prompt' do
      row_with_2_choices[:prompt] = 'normal **bold** normal __italic__ @@menu@@'
  ...
  describe '#valid?' do
    ...
    context 'when the "prompt" field does not contain the string @@menu@@' do
      before do
        row_with_2_choices[:prompt] = 'this has no menu placeholder'
      end
      ...
      it 'sets an error' do
        ...
        expect(builder.errors).to contain_exactly(
          "line 2: 'prompt' field contains no menu placeholder (indicated by @@menu@@)"
        )
      end
    ...
    context 'when the "prompt" field contains the string @@menu@@ more than once' do
      before do
        row_with_2_choices[:prompt] = 'this has @@menu@@ menu placeholders @@menu@@'
      end
      ...
      it 'sets an error' do
        ...
        expect(builder.errors).to contain_exactly(
          "line 2: 'prompt' field contains more than one menu placeholder " \
          '(indicated by @@menu@@)'
        )
      end
