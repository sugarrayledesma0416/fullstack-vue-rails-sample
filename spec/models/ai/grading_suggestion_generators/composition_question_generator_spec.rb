describe AI::GradingSuggestionGenerators::CompositionQuestionGenerator do
  ...
  describe '#generate' do
    ...
    context 'when the attempt has no response for a question,' do
      it 'does not a composition question generator job to the sidekiq queue for that question' do
        generator.generate
