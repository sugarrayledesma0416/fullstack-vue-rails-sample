describe AI::OverallCommentGenerators::ActivityGenerator do
  ...
  let(:open_ended_activity_generator_worker_class) do
    AI::OverallCommentGenerators::OpenEndedActivityGeneratorWorker
  end

  let(:composition_activity_generator_worker_class) do
    AI::OverallCommentGenerators::CompositionActivityGeneratorWorker
  end
