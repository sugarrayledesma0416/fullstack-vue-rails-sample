feature 'External Link Activity', js: true, chrome: true do
  ...
  let(:item) { MaestroActivityEngine::ActivityContent::ExternalLink::Item.new }
  ...
  context 'when logged in as student' do
    before do
      item.external_link_url = 'https://dummy-url-1.com/'
    ...
    scenario 'I can view the external link activity content' do
      visit section_activity_path(section.id, activity)
