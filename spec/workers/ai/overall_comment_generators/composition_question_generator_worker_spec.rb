describe AI::OverallCommentGenerators::CompositionQuestionGeneratorWorker do
  ...
  let(:generator) do
    instance_double(AI::OverallCommentGenerators::CompositionQuestionGenerator)
  end

  before do
    allow(AI::OverallCommentGenerators::CompositionQuestionGenerator)
      .to receive(:new)
