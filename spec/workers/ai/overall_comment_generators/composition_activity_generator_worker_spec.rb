describe AI::OverallCommentGenerators::CompositionActivityGeneratorWorker do
  ...
  let(:generator) do
    instance_double(AI::OverallCommentGenerators::CompositionActivityGenerator)
  end

  before do
    allow(AI::OverallCommentGenerators::CompositionActivityGenerator)
      .to receive(:new)
