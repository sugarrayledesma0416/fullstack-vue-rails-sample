describe AI::GradingSuggestionGenerators::OpenEndedActivityGeneratorWorker do
  ...
  let(:generator) do
    instance_double(AI::GradingSuggestionGenerators::OpenEndedActivityGenerator)
  end

  before do
    allow(AI::GradingSuggestionGenerators::OpenEndedActivityGenerator)
      .to receive(:new)
