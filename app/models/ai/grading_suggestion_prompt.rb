module AI
  class GradingSuggestionPrompt < ApplicationRecord
    self.table_name = 'ai_grading_suggestion_prompts'

    DEFAULT_SYSTEM_MESSAGE_TEMPLATE = VHL::AI::Prompts::GRADING_SUGGESTION_PROMPT
    ...
    def self.using_ai_core_source?(language_code = nil)
      defined?(VHL::AI::Prompts) && VHL::AI::Prompts.has_prompt?('grading_suggestion', language_code)
    end
    ...
    def self.sync_from_ai_core_if_needed(language_code = nil)
      ...
      return if active_prompt&.template_body == ai_core_template
