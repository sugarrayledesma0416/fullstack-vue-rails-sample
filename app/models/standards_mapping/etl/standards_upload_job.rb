module StandardsMapping
  module Etl
    module StandardsUploadJob
      # to run this Kiba job, call from rake task or sidekiq worker
      # job = StandardsMapping:Etl::StandardsUploadJob.setup(params)
      # Kiba.run(job)
      ...
      def setup(config_params)
        Kiba.parse do
          source StandardsMapping::Etl::StandardSource, config_params
          transform StandardsMapping::Etl::StandardTransform, config_params
