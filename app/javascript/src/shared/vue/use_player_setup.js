 ...
 * onPlayerDeactivate,
 */
const usePlayerSetup = (refPlayerInstance, localState, recorderState) => {
  /**
   * Setup method to initialize AudioPlayer.
   * @param {String} recordingPath - The relative path to the recording
   */
  const setupAudioPlayer = (recordingPath) => {
  ...
  const initPlayer = (recordingPath) => {
    ...
    const recordingUrl = recordingPath;
