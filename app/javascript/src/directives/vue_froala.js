...
export default (App, Options = {}) => {
  const froalaEditorFunctionality = {
    ...
    data: function() {
      return {
        ...
        /* @type {HTMLElement} Element on which the editor is initialized. */
        currentTag: 'div',
  ...
  const froalaViewFunctionality = {
    ...
    render: function() {
      return h(this.currentTag, { class: 'fr-view' });
    },
