  ...
  return defineConfig({
    ...
    plugins: [
      ...
      copy({
        ...
        targets: [
          {
            src: resolve(__dirname, 'node_modules/music/app/javascript/src/v3/assets/'),
            dest: resolve(__dirname, 'public/music_v3'),
          }
        ],
      })
    ],
    resolve: {
      alias: {
        '!!raw-loader!MusicAssets/images/music/v1/icons': resolve(__dirname, 'node_modules/music/app/assets/images/music/v1/icons'),
        'MusicV3': resolve(__dirname, 'node_modules/music/app/javascript/src'),
        'MusicAssets': resolve(__dirname, 'node_modules/music/app/assets'),
      },
      extensions: [
        '.css',
        '.mjs',
